            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid ">
                        <h1 class="mt-4">Data Customer CV. Teknik Steel</h1>
                        </ol>
                            <div class="card mb-4">  
                            ...
                            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$hp;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idcust;?>">
                                                Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idcust;?>">
                                                Delete
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <!-- Edit The Modal -->
                                            <div class="modal fade" id="edit<?=$idcust;?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <input type="text" name="namacustomer" value="<?=$namacustomer;?>" class="form-control" required>
                                                        ...
                                                        <input type="text" name="hp" value="<?=$hp;?>" class="form-control" required>
                                                        </br>
                                                    <input type="hidden" name="idcust" value="<?=$idcust;?>"> 
                                                    <button type="submit" class="btn btn-primary" name="updates">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <!-- Delete The Modal -->
                                                            <div class="modal fade" id="delete<?=$idcust;?>">
                                                                <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="post">
                                                                    <div class="modal-body">
                                                                    Apakah Anda Yakin ingin menghapus <?=$namacustomer;?>?
                                                                        </br>
                                                                        </br> 
                                                                        <input type="hidden" name="idcust" value="<?=$idcust;?>">       
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="number" name="hp" placeholder="no hp" class="form-control" required>
            </br>
