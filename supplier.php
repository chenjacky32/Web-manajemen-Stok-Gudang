            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid ">
                        <h1 class="mt-4">Data Supplier CV. Teknik Steel</h1>
                        </ol>
                            <div class="card mb-4">  
                        ...
                        <table id="datatablesSimple">
                            <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $ambilsemuadatastock = mysqli_query($conn,"select * from supplier");
                                        $i = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$hp;?></td>
                                            <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?=$idsupp;?>">
                                                Edit
                                                </button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idsupp;?>">
                                                Delete
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal fade" id="edit<?=$idsupp;?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <input type="hidden" name="idsupplier" value="<?=$idsupp;?>"> 
